<div class="col-lg-4">
  ...
  <ul class="nav-news-feed">
    ...
    <li><i class="fa fa-video-camera <?php if($_SERVER['PHP_SELF'] == '/feed/my_videos.php') echo 'icon1'?>"></i>
      <div><a href="my_videos.php" <?php if($_SERVER['PHP_SELF'] == '/feed/my_videos.php') echo 'class="active"'?>>Видео</a></div>
    </li>
